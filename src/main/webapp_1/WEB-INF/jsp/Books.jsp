         ...
         <table>
            <thread>
             ...
             <c:forEach var="book" items="${books}">
                 <tr>
                     <td> ${book.id}</td>
                     <td style="padding-left: 15px" align="left"><a href="/authors?authorId=${book.bid}">${book.name}</a> </td>
                     <td><a class="btn btn-warning" href="/UpdateBook?authorId=${book.id}">Update</a></td>
                     <td><a class="btn btn-danger" href="/Delete?authorId=${book.id}">Delete</a></td>
                 </tr>
             </c:forEach>
             <tr>
